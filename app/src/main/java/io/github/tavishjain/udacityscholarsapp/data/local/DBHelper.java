...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_NOTIFICATION_TABLE = "CREATE TABLE " +
            ...
            NotificationContract.NotificationEntry.COLUMN_TIMESTAMP + " INTEGER NOT NULL," +
            ...
            NotificationContract.NotificationEntry.COLUMN_EXTRA_1 + " TEXT," +
            NotificationContract.NotificationEntry.COLUMN_EXTRA_2 + " TEXT" +
            "); ";
